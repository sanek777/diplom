...
class quad_mesh:
    ...
    def quad_change(self, q00, q01, q11, q10):
        p_temp = (np.dot(cross_vectors(self.points[q01[0]][q01[1]][:],self.points[q00[0]][q00[1]][:]), self.points[q10[0]][q10[1]][:])*
                  np.dot(cross_vectors(self.points[q10[0]][q10[1]][:],self.points[q11[0]][q11[1]][:]), self.points[q01[0]][q01[1]][:])/
                  np.dot(cross_vectors(self.points[q11[0]][q11[1]][:],self.points[q01[0]][q01[1]][:]), self.points[q00[0]][q00[1]][:])/
                  np.dot(cross_vectors(self.points[q00[0]][q00[1]][:],self.points[q10[0]][q10[1]][:]), self.points[q11[0]][q11[1]][:]))
    ...
    def find_parameter(self, q00, q01, q11, q10, point):
        ...
        point_temp[2] = 1
        a_s = cross_vectors(
            cross_vectors(self.points[q00[0]][q00[1]][:],self.points[q01[0]][q01[1]][:]),
            cross_vectors(self.points[q10[0]][q10[1]][:],self.points[q11[0]][q11[1]][:]))
        a_t = cross_vectors(
            cross_vectors(self.points[q00[0]][q00[1]][:],self.points[q10[0]][q10[1]][:]),
            cross_vectors(self.points[q01[0]][q01[1]][:],self.points[q11[0]][q11[1]][:]))
        param = np.zeros(2)
        param[0] = (np.dot(cross_vectors(a_s,self.weights[q01[0]][q01[1]]*self.points[q01[0]][q01[1]][:]), point_temp)/
                    (np.dot(cross_vectors(a_s,self.weights[q01[0]][q01[1]]*self.points[q01[0]][q01[1]][:]), point_temp) -
                            np.dot(cross_vectors(a_s,self.weights[q11[0]][q11[1]]*self.points[q11[0]][q11[1]][:]), point_temp)))
        param[1] = (np.dot(cross_vectors(a_t,self.weights[q10[0]][q10[1]]*self.points[q10[0]][q10[1]][:]), point_temp)/
                    (np.dot(cross_vectors(a_t,self.weights[q10[0]][q10[1]]*self.points[q10[0]][q10[1]][:]), point_temp) -
                            np.dot(cross_vectors(a_t,self.weights[q11[0]][q11[1]]*self.points[q11[0]][q11[1]][:]), point_temp)))
        return param
